...
That exporter now supports raw-key inspection and explicit key remapping so the upstream Haiku module names can be reconciled with the Rust loader contract incrementally.
